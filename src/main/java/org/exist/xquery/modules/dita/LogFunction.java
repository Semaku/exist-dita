...
public class LogFunction extends BasicFunction {
    ...
    public final static FunctionSignature signatures[] = {
            new FunctionSignature(
                    new QName(FUNCTION_LOG, DitaModule.NAMESPACE_URI, DitaModule.PREFIX),
                    "Logs the message to the current logger.",
                    new SequenceType[]{PRIORITY_PARAMETER, MESSAGE_PARAMETER},
                    new SequenceType(Type.ITEM, Cardinality.EMPTY)
            ),
            new FunctionSignature(
                    new QName(FUNCTION_LOG_SYSTEM_OUT, DitaModule.NAMESPACE_URI, DitaModule.PREFIX),
                    "Logs the message to System.out.",
                    new SequenceType[]{MESSAGE_PARAMETER},
                    new SequenceType(Type.ITEM, Cardinality.EMPTY)
            ),
            new FunctionSignature(
                    new QName(FUNCTION_LOG_SYSTEM_ERR, DitaModule.NAMESPACE_URI, DitaModule.PREFIX),
                    "Logs the message to System.err.",
                    new SequenceType[]{MESSAGE_PARAMETER},
                    new SequenceType(Type.ITEM, Cardinality.EMPTY)
            ),
            new FunctionSignature(
                    new QName(FUNCTION_LOGAPP, DitaModule.NAMESPACE_URI, DitaModule.PREFIX),
